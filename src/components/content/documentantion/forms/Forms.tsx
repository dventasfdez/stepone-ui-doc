...
import { SimpleForm, simple_result } from "../../../../app/documentation/forms/examples/form-examples";
import ComponentExample from "../ComponentExample";
import { FormExampleWithValidations, form_validations_example } from "../../../../app/documentation/forms/examples/form-example-with-validations";
    ...
    <div>
      ...
      <div id="form-examples">
        ...
        <div className="mb6" id="typical-form">
          <Card>
            <CardHeader>
              <h3>Form with validations, initial values and input change events</h3>
              <span className="subtitle"></span>
            </CardHeader>
            <CardBody>
      ...
      <div id="validations">
        ...
        <div id="default-validations" className="mb4">
          ...
          <SyntaxHighlighter style={vs2015} language={"typecript"}>{`<TextInput validations={[required, url]} label="Text input" name="textInput" />`}</SyntaxHighlighter>
        </div>
        ...
        <div id="custom-validations" className="mb4">
          ...
          <SyntaxHighlighter style={vs2015} language={"typecript"}>{`const customValidationFunction = (value: any, _context: any, inputComponent: any) => {
...
`}</SyntaxHighlighter>
        ...
        <div id="async-validations" className="mb4">
          ...
          <SyntaxHighlighter style={vs2015} language={"typecript"}>{`const validEmail = async (value: any, _context: any, inputComponent: any) => {
...
`}</SyntaxHighlighter>
        ...
        <div id="multiple-field-dependencies" className="mb4">
          ...
          <SyntaxHighlighter style={vs2015} language={"typecript"}>{`export const dateFrom = (value: any, context: any, inputComponent: any) => {
  try {
    let toDate = null;
    let nameToSearch = "";
    ...
    return moment(value, config.date_format, true) > moment(toDate.state.value, config.date_format, true) ? "End date is earlier than start date" : validationIsGood;
        ...
        <div id="validate-on-field-props" className="mb4">
          ...
          <SyntaxHighlighter style={vs2015} language={"typecript"}>{`export const customValidation = (value: any, context: any, inputComponent: any) => {
      ...
      <div id="serialization">
        ...
        <div id="initial-values" className="mb4">
          ...
          <SyntaxHighlighter style={vs2015} language={"typecript"}>{`<Form  values={{ salutation: "Good afternoon", color: ["blue"] }}>
      ...
      <input type="submit" value="Submit" />
        ...
        <div id="complex-objects" className="mb4">
          ...
          <SyntaxHighlighter style={vs2015} language={"typecript"}>{`  <TextInput  label="Example" name="nestedObject[0].property" />`}</SyntaxHighlighter>
          <p className="mt4"> In the following case, the output would be: </p>

          <SyntaxHighlighter style={vs2015} language={"json"}>{`{ "nestedObject": [ { "property": "Value example" } ] }`}</SyntaxHighlighter>
        </div>
      </div>
      ...
      <div id="events">
        ...
        <div className="mb4" id="event-submit">
          ...
          <SyntaxHighlighter style={vs2015} language={"typecript"}>{`const handleSubmit = async (event: any) => {
  ...
  <Form ref={formRef} onSubmit={handleSubmit}>
      ...
      <button type="submit">Submit</button>
        ...
        <div className="mb4" id="event-input-change">
          ...
          <SyntaxHighlighter style={vs2015} language={"typecript"}>{`const handleInputChange = async (event: any) => { 
  ...
  <Form ref={formRef} onChange={handleInputChange}>
      ...
      <div id="external-methods">
        ...
        <div className="mb4" id="external-methods-validate">
          ...
          <SyntaxHighlighter className="mb4" style={vs2015} language={"typecript"}>{` const isValid = await formRef?.current?.isValid();`}</SyntaxHighlighter>
          <p>
            <strong>formRef.current.isValid()</strong>: returns true or false.
          </p>

          <SyntaxHighlighter className="mb4" style={vs2015} language={"typecript"}>{`const validationOutput = await formRef.current.getValidation();`}</SyntaxHighlighter>
        </div>
        ...
        <div className="mb4" id="external-methods-submit">
          ...
          <SyntaxHighlighter style={vs2015} language={"typecript"}>{` formRef.current.submit()`}</SyntaxHighlighter>
        </div>
        ...
        <div className="mb4" id="external-methods-reset">
          ...
          <SyntaxHighlighter style={vs2015} language={"typecript"}>{` formRef.current.resetFields()`}</SyntaxHighlighter>
        </div>
      </div>
      ...
      <div id="known-limitations">
        ...
        <div className="mb4" id="nesting-forms">
          ...
          <SyntaxHighlighter style={vs2015} language={"typecript"}>{`<button type="button" onClick={() => handleSubmit()}>Save user</button>`}</SyntaxHighlighter>

          <p>Here is an example</p>

          <SyntaxHighlighter style={vs2015} language={"typecript"}>{`import _ from "lodash";
