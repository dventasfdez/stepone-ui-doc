    ...
    <>
      <div className="g-container">
        <div className="markdown prose w-full break-words dark:prose-invert light">
          ...
          <p>
            These downloads and examples are designed to help you quickly get started with StepOne and showcase its capabilities. Feel free to download the library, explore the examples, and customize
            them to fit your project&apos;s requirements. If you have any questions or need further assistance, refer to the StepOne documentation or reach out to our support team. Happy coding!
          </p>
        </div>
